...
Page({
        ...
        wx.getSystemInfo({
            success: function (res) {
                ...
                that.setData({
                    ...
                    avatarWidth:scaleNum*164,
                    avatarTop:scaleNum*293,
                    avatarLeft:scaleNum*100,
                    nickNameTop:scaleNum*480,
                    nickNameLeft:scaleNum*190,
                    qcodeTop:scaleNum*998,
                    qcodeLeft:scaleNum*948,
                    qcodeWidth:scaleNum*300*0.8,
                    txtTop:scaleNum*540,
                    txtLeft:scaleNum*118,
    ...
    onShareAppMessage: function (res) {
        ...
        return {
            ...
            imageUrl:'https://werun.renlai.fun/static/cposition/share.jpg?123',
            success: function (res) {
    ...
    downloadAvatar: function () {
        ...
        var bgImageitem
        if(this.data.stateValueA == 100){
            bgImageitem = that.data.bgImage[0];
        }else if(this.data.stateValueB == 100){
            bgImageitem = that.data.bgImage[1];
        }else if(this.data.stateValueC == 100){
            bgImageitem = that.data.bgImage[3];
        }else if(this.data.stateValueD == 100){
            bgImageitem = that.data.bgImage[2];
        }
...
///结束
        ...
        ctx.beginPath();
        ctx.arc(that.data.qcodeLeft + that.data.qcodeWidth / 2, that.data.qcodeWidth/2+that.data.qcodeTop, that.data.qcodeWidth/2*1.1, 0, 2 * Math.PI,false);
        ctx.setFillStyle("#ffffff");
        ctx.fill();
        ctx.clip();
        ...
        ctx.beginPath();
        ctx.arc(that.data.avatarWidth/2+avatarStrokeWidth+that.data.avatarLeft, that.data.avatarWidth/2+avatarStrokeWidth+that.data.avatarTop, that.data.avatarWidth/2, 0, 2 * Math.PI,true);
